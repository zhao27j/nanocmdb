...
urlpatterns += [
    ...
    path('instance/<pk>/statusupdate/', views.InstanceStatusUpdate.as_view(), name='instance-status-upd'),
...
urlpatterns += [
    ...
    path('modeltype/<int:pk>/', views.ModelTypeDetailView.as_view(), name='modeltype-detail'),
